...
description: Covers `nhl-score-api` test conventions (structure, naming, variable naming, literal expected assertions, and fixture access via resource accessors). Use when writing or updating Kaocha/Clojure tests for this project.
---
